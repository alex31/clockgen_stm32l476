...
#define	PB02_LCD_E                     2U
#define	PB03_LCD_D0                    3U
#define	PB04_LCD_D1                    4U
#define	PB05_LCD_D2                    5U
#define	PB06_CLOCK_F2_OUT              6U
#define	PB07_LCD_D3                    7U
#define	PB08_BOUTON_F1_SW              8U
#define	PB09_BOUTON_F2_SW              9U
#define	PB10                           10U
#define	PB11                           11U
#define	PB12                           12U
#define	PB13                           13U
...
#define	LINE_LCD_E                     PAL_LINE(GPIOB, 2U)
#define	LINE_LCD_D0                    PAL_LINE(GPIOB, 3U)
#define	LINE_LCD_D1                    PAL_LINE(GPIOB, 4U)
#define	LINE_LCD_D2                    PAL_LINE(GPIOB, 5U)
#define	LINE_CLOCK_F2_OUT              PAL_LINE(GPIOB, 6U)
#define	LINE_LCD_D3                    PAL_LINE(GPIOB, 7U)
#define	LINE_BOUTON_F1_SW              PAL_LINE(GPIOB, 8U)
#define	LINE_BOUTON_F2_SW              PAL_LINE(GPIOB, 9U)
...
#define VAL_GPIOB_MODER                 (PIN_MODE_OUTPUT(PB00_LCD_RS) | \
					 ...
					 PIN_MODE_OUTPUT(PB02_LCD_E) | \
					 PIN_MODE_OUTPUT(PB03_LCD_D0) | \
					 PIN_MODE_OUTPUT(PB04_LCD_D1) | \
					 PIN_MODE_OUTPUT(PB05_LCD_D2) | \
					 PIN_MODE_ALTERNATE(PB06_CLOCK_F2_OUT) | \
					 PIN_MODE_OUTPUT(PB07_LCD_D3) | \
					 PIN_MODE_INPUT(PB08_BOUTON_F1_SW) | \
					 PIN_MODE_INPUT(PB09_BOUTON_F2_SW) | \
...
#define VAL_GPIOB_OTYPER                (PIN_OTYPE_PUSHPULL(PB00_LCD_RS) | \
					 PIN_OTYPE_PUSHPULL(PB01_LCD_RW) | \
					 PIN_OTYPE_PUSHPULL(PB02_LCD_E) | \
					 PIN_OTYPE_PUSHPULL(PB03_LCD_D0) | \
					 PIN_OTYPE_PUSHPULL(PB04_LCD_D1) | \
					 PIN_OTYPE_PUSHPULL(PB05_LCD_D2) | \
					 PIN_OTYPE_PUSHPULL(PB06_CLOCK_F2_OUT) | \
					 PIN_OTYPE_PUSHPULL(PB07_LCD_D3) | \
					 PIN_OTYPE_OPENDRAIN(PB08_BOUTON_F1_SW) | \
					 PIN_OTYPE_OPENDRAIN(PB09_BOUTON_F2_SW) | \
...
#define VAL_GPIOB_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PB00_LCD_RS) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB01_LCD_RW) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB02_LCD_E) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB03_LCD_D0) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB04_LCD_D1) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB05_LCD_D2) | \
					 PIN_OSPEED_SPEED_HIGH(PB06_CLOCK_F2_OUT) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB07_LCD_D3) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB08_BOUTON_F1_SW) | \
					 PIN_OSPEED_SPEED_VERYLOW(PB09_BOUTON_F2_SW) | \
...
#define VAL_GPIOB_PUPDR                 (PIN_PUPDR_FLOATING(PB00_LCD_RS) | \
					 PIN_PUPDR_FLOATING(PB01_LCD_RW) | \
					 PIN_PUPDR_FLOATING(PB02_LCD_E) | \
					 PIN_PUPDR_FLOATING(PB03_LCD_D0) | \
					 PIN_PUPDR_FLOATING(PB04_LCD_D1) | \
					 PIN_PUPDR_FLOATING(PB05_LCD_D2) | \
					 PIN_PUPDR_FLOATING(PB06_CLOCK_F2_OUT) | \
					 PIN_PUPDR_FLOATING(PB07_LCD_D3) | \
					 PIN_PUPDR_PULLUP(PB08_BOUTON_F1_SW) | \
					 PIN_PUPDR_PULLUP(PB09_BOUTON_F2_SW) | \
...
#define VAL_GPIOB_ODR                   (PIN_ODR_LEVEL_LOW(PB00_LCD_RS) | \
					 PIN_ODR_LEVEL_LOW(PB01_LCD_RW) | \
					 PIN_ODR_LEVEL_LOW(PB02_LCD_E) | \
					 PIN_ODR_LEVEL_LOW(PB03_LCD_D0) | \
					 PIN_ODR_LEVEL_LOW(PB04_LCD_D1) | \
					 PIN_ODR_LEVEL_LOW(PB05_LCD_D2) | \
					 PIN_ODR_LEVEL_LOW(PB06_CLOCK_F2_OUT) | \
					 PIN_ODR_LEVEL_LOW(PB07_LCD_D3) | \
					 PIN_ODR_LEVEL_LOW(PB08_BOUTON_F1_SW) | \
					 PIN_ODR_LEVEL_LOW(PB09_BOUTON_F2_SW) | \
...
#define VAL_GPIOB_AFRL			(PIN_AFIO_AF(PB00_LCD_RS, 0) | \
					 PIN_AFIO_AF(PB01_LCD_RW, 0) | \
					 PIN_AFIO_AF(PB02_LCD_E, 0) | \
					 PIN_AFIO_AF(PB03_LCD_D0, 0) | \
					 PIN_AFIO_AF(PB04_LCD_D1, 0) | \
					 PIN_AFIO_AF(PB05_LCD_D2, 0) | \
					 PIN_AFIO_AF(PB06_CLOCK_F2_OUT, 2) | \
					 PIN_AFIO_AF(PB07_LCD_D3, 0))

#define VAL_GPIOB_AFRH			(PIN_AFIO_AF(PB08_BOUTON_F1_SW, 0) | \
					 PIN_AFIO_AF(PB09_BOUTON_F2_SW, 0) | \
					 PIN_AFIO_AF(PB10, 0) | \
					 PIN_AFIO_AF(PB11, 0) | \
					 PIN_AFIO_AF(PB12, 0) | \
					 PIN_AFIO_AF(PB13, 0) | \
...
#define VAL_GPIOB_ASCR                  (PIN_ASCR_DISABLED(PB00_LCD_RS) | \
					 PIN_ASCR_DISABLED(PB01_LCD_RW) | \
					 PIN_ASCR_DISABLED(PB02_LCD_E) | \
					 PIN_ASCR_DISABLED(PB03_LCD_D0) | \
					 PIN_ASCR_DISABLED(PB04_LCD_D1) | \
					 PIN_ASCR_DISABLED(PB05_LCD_D2) | \
					 PIN_ASCR_DISABLED(PB06_CLOCK_F2_OUT) | \
					 PIN_ASCR_DISABLED(PB07_LCD_D3) | \
					 PIN_ASCR_DISABLED(PB08_BOUTON_F1_SW) | \
					 PIN_ASCR_DISABLED(PB09_BOUTON_F2_SW) | \
...
#define VAL_GPIOB_LOCKR                 (PIN_LOCKR_DISABLED(PB00_LCD_RS) | \
					 PIN_LOCKR_DISABLED(PB01_LCD_RW) | \
					 PIN_LOCKR_DISABLED(PB02_LCD_E) | \
					 PIN_LOCKR_DISABLED(PB03_LCD_D0) | \
					 PIN_LOCKR_DISABLED(PB04_LCD_D1) | \
					 PIN_LOCKR_DISABLED(PB05_LCD_D2) | \
					 PIN_LOCKR_DISABLED(PB06_CLOCK_F2_OUT) | \
					 PIN_LOCKR_DISABLED(PB07_LCD_D3) | \
					 PIN_LOCKR_DISABLED(PB08_BOUTON_F1_SW) | \
					 PIN_LOCKR_DISABLED(PB09_BOUTON_F2_SW) | \
